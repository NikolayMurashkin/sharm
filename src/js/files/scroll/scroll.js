...
//Для работы добавить класс _anim-items к блоку, содержимое которого хотим анимировать.
//Добавление блоку с классом _anim-items класс _scrolled
		...
		function animOnScroll(params) {
			for (let index = 0; index < animItems.length; index++) {
				...
				if ((window.pageYOffset > animItemOffset - animItemPoint) && window.pageYOffset < (animItemOffset + animItemHeight)) {
					animItem.classList.add('_scrolled');
				} else {
